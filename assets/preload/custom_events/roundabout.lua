...
function onCreate()
    ...
    makeAnimatedLuaSprite('roundaboutinvisible2', 'bull/Roundabout', getProperty('boyfriend.x') + 1300, getProperty('dad.y'));
...
function onTimerCompleted(t, l, ll) 
    if t == 'doeventroundabout' then
        ...
        doTweenX('weeeeeroundabout1', 'roundabout', getProperty('boyfriend.x') + 1300, 1.3, 'sineInOut')
        doTweenX('weeeeeroundabout2', 'roundaboutinvisible', getProperty('boyfriend.x') + 1300, 0.6, 'sineInOut')
...
function onUpdate()
    if getProperty('roundaboutinvisible.x') == getProperty('boyfriend.x') + 800 then
    ...
    if getProperty('roundaboutinvisible2.x') == getProperty('boyfriend.x') + 800 - 200 then
      ...
      --   characterPlayAnim('boyfriend', 'dodge', true);
        setProperty('roundaboutinvisible2.x', getProperty('boyfriend.x') + 800)
      --   runTimer('goback', 0.3, 1)
      end
...
function onTweenCompleted(t) 
   if t == 'weeeeeroundabout1' then
    ...
    doTweenX('weeeeeroundabout4', 'roundaboutinvisible2', getProperty('boyfriend.x') + 1300 - 200, 0.3, 'sineInOut')
   end
